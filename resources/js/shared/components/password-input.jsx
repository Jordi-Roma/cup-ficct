...
export default function PasswordInput({ className, ref, ...props }) {
    ...
    return (<div className="relative">
            ...
            <button type="button" onClick={() => setShowPassword((prev) => !prev)} className="absolute inset-y-0 right-0 flex items-center rounded-r-md px-3 text-muted-foreground hover:text-foreground focus-visible:ring-[3px] focus-visible:ring-ring focus-visible:outline-none" aria-label={showPassword ? 'Ocultar contrasena' : 'Mostrar contrasena'} tabIndex={-1}>
