...
import type { CarreraOption, Postulante } from '../types/postulante';
...
export default function PostulanteForm({
    ...
    const { data, setData, put, processing, errors } = useForm({
        ...
        id_carrera_opcion1:
            postulante.postulacion?.carrera_opcion1?.id_carrera?.toString() ??
            '',
        id_carrera_opcion2:
            postulante.postulacion?.carrera_opcion2?.id_carrera?.toString() ??
            '',
    });
        ...
        <form onSubmit={submit} className="space-y-5">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
                <div className="grid gap-2">
                    ...
                    <Input
                        ...
                        onChange={(event) =>
                            setData('fecha_nacimiento', event.target.value)
                        }
                    />
                ...
                <div className="grid gap-2">
                    ...
                    <Input
                        ...
                        value={data.ciudad}
                        onChange={(event) =>
                            setData('ciudad', event.target.value)
                        }
                    />
            ...
            <div className="grid gap-2">
                ...
                <Input
                    ...
                    onChange={(event) =>
                        setData('colegio_procedencia', event.target.value)
                    }
                />
            ...
            <div className="grid gap-4 sm:grid-cols-2">
                <div className="grid gap-2">
                    ...
                    <Select
                        value={data.id_carrera_opcion1}
                        onValueChange={(value) =>
                            setData('id_carrera_opcion1', value)
                        }
                    >
                ...
                <div className="grid gap-2">
                    ...
                    <Select
                        value={data.id_carrera_opcion2 || 'none'}
                        onValueChange={(value) =>
                            setData(
                                'id_carrera_opcion2',
                                value === 'none' ? '' : value,
            ...
            <Label className="flex items-center gap-3 rounded-md border p-3">
                <Checkbox
                    checked={data.documentacion_completa}
                    onCheckedChange={(checked) =>
                        setData('documentacion_completa', checked === true)
                    }
                />
