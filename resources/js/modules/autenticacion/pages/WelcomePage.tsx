                    ...
                    <div className="relative z-10 grid flex-1 items-center gap-10 py-10 lg:grid-cols-[0.9fr_1.1fr] lg:py-6">
                        <div className="max-w-2xl space-y-8">
                            ...
                            <div className="flex flex-col gap-3 sm:flex-row">
                                {auth.user ? (
                                    <Button
                                        asChild
                                        className="h-12 bg-[#061d3b] px-6 text-base hover:bg-[#0b2a52]"
                                    >
                                        <Link href={dashboard()}>
                                            Ir al dashboard
                                        </Link>
                                    ...
                                    <>
                                        ...
                                        <Button
                                            asChild
                                            className="h-12 bg-[#e30613] px-6 text-base hover:bg-[#bb0710]"
                                        >
                                            <Link href={register()}>
                            ...
                            <div className="lg:hidden">
                                ...
                                <div className="grid grid-cols-2 gap-3">
                                    {subjects.map((subject) => (
                                        <div
                                            key={subject.name}
                                            className="flex items-center gap-2 rounded-lg border border-slate-200 bg-white p-3 text-sm font-medium text-slate-700 shadow-sm"
                                        >
                        ...
                        <div className="relative hidden min-h-[680px] lg:block">
                            <div className="absolute inset-y-0 -right-12 left-0 overflow-hidden rounded-l-[2rem] border border-slate-200 bg-white shadow-2xl">
                                <img
                                    src="/images/cup-ficct-hero.png"
                                    alt="Postulantes frente a la Facultad de Ingeniería de la FICCT"
