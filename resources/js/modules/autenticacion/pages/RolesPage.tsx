...
import RoleForm from '@/modules/autenticacion/components/RoleForm';
import RolesTable from '@/modules/autenticacion/components/RolesTable';
            ...
            <Dialog open={open} onOpenChange={setOpen}>
                <DialogContent className="sm:max-w-3xl">
                    ...
                    <RoleForm
                        role={selectedRole}
                        permisosPorModulo={permisosPorModulo}
                        canSubmit={selectedRole ? canUpdate : canCreate}
