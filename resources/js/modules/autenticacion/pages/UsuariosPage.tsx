...
export default function UsuariosPage({ usuarios, roles }: Props) {
    ...
    const { data, setData, put, processing } = useForm({
        estado_acceso: 'HABILITADO' as Usuario['estado_acceso'],
        activo: true,
    });
    ...
    const openAccess = (usuario: Usuario) => {
        if (!canUpdate) {
            return;
        }
                        ...
                        <div className="grid gap-2">
                            ...
                            <Select
                                ...
                                onValueChange={(value) =>
                                    setData(
                                        'estado_acceso',
                                        value as Usuario['estado_acceso'],
                                    )
                                }
                            >
