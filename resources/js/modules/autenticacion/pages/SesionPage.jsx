                ...
                {({ processing, errors }) => (<>
                        <div className="grid gap-6">
                            <div className="grid gap-2">
                                ...
                                <Input id="username" type="text" name="username" required autoFocus tabIndex={1} autoComplete="username" placeholder="tu.usuario"/>
                            ...
                            <div className="grid gap-2">
                                ...
                                <PasswordInput id="password" name="password" required tabIndex={2} autoComplete="current-password" placeholder="Contraseña"/>
                            ...
                            <Button type="submit" className="mt-4 w-full bg-[#061d3b] text-white hover:bg-[#0b2a52]" tabIndex={4} disabled={processing} data-test="login-button">
                                {processing && <Spinner />}
                                Iniciar sesión
                            </Button>
                        </div>
