        ...
        <main className="grid min-h-svh bg-slate-50 lg:grid-cols-[1.05fr_0.95fr]">
            <section className="relative hidden overflow-hidden bg-[#061d3b] text-white lg:block">
                <img
                    ...
                    alt="Edificio académico del CUP-FICCT"
                ...
                <div className="relative z-10 flex h-full flex-col justify-between p-10 xl:p-14">
                    <Link
                        href={home()}
                        className="flex w-fit items-center gap-3 text-base font-semibold"
                    >
            ...
            <section className="flex min-h-svh items-center justify-center px-6 py-10 sm:px-8">
                <div
                    className={`w-full space-y-8 ${isRegister ? 'max-w-2xl' : 'max-w-md'}`}
                >
                    <div className="flex flex-col items-center gap-4 text-center lg:items-start lg:text-left">
                        <Link
                            href={home()}
                            className="flex items-center gap-3 font-semibold lg:hidden"
                        >
