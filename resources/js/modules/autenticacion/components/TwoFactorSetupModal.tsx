...
import { OTP_MAX_LENGTH } from '@/modules/autenticacion/hooks/use-two-factor-auth';
...
export default function TwoFactorSetupModal({
    ...
    const modalConfig = useMemo<{
        ...
        if (twoFactorEnabled) {
            return {
                title: 'Autenticacion en dos pasos activada',
                description:
                    'La autenticacion en dos pasos ya esta activada. Escanea el codigo QR o ingresa la clave en tu aplicacion de autenticacion.',
                buttonText: 'Cerrar',
            };
        }
        ...
        return {
            ...
            description:
                'Para terminar, escanea el codigo QR o ingresa la clave en tu aplicacion de autenticacion',
            buttonText: 'Continuar',
        };
