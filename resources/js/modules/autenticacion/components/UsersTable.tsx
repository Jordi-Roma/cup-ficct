...
import type { Usuario } from '../types/access-control';

type Props = {
    usuarios: Usuario[];
    onEditAccess: (usuario: Usuario) => void;
    onEditRoles: (usuario: Usuario) => void;
    canUpdate: boolean;
};
                ...
                {usuarios.map((usuario) => (
                    ...
                    >
                        ...
                        <div className="flex flex-wrap gap-2">
                            ...
                            {usuario.roles.map((role) => (
                                <Badge key={role.id_rol} variant="secondary">
                                    {role.nombre}
                                </Badge>
                            ))}
                        </div>
