...
export default function MateriasCupPage({ materias }) {
    ...
    const activeCount = useMemo(() => materias.filter((materia) => materia.activo).length, [materias]);
    const openCreate = () => {
    ...
    return (<>
            ...
            <div className="space-y-6 p-4 md:p-6">
                ...
                <Card>
                    ...
                    <div className="px-6 pb-6">
                        <MateriasCupTable materias={materias} canUpdate={canUpdate} canToggle={canToggle} onEdit={openEdit}/>
                    </div>
                </Card>
            </div>
            ...
            <Dialog open={open} onOpenChange={setOpen}>
                <DialogContent>
                    ...
                    <MateriaCupForm materia={selectedMateria} canSubmit={selectedMateria ? canUpdate : canCreate} onSuccess={() => setOpen(false)}/>
                </DialogContent>
            </Dialog>
        </>);
}
