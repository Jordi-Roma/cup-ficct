...
export default function GruposAcademicosPage({ grupos, resumen }) {
    ...
    const [selectedPostulantesGrupo, setSelectedPostulantesGrupo] = useState(null);
    const openCreate = () => {
    ...
    return (<>
            ...
            <div className="space-y-6 p-4 md:p-6">
                <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                    ...
                    <div className="flex flex-col gap-2 sm:flex-row">
                        {canCreate && (<>
                                <Button type="button" variant="outline" onClick={generateGroups}>
                ...
                <Card>
                    ...
                    <div className="px-6 pb-6">
                        <GruposAcademicosTable grupos={grupos} canUpdate={canUpdate} canToggle={canToggle} canViewPostulantes={canRead} onEdit={openEdit} onViewPostulantes={openPostulantes}/>
                    </div>
                </Card>
            </div>
            ...
            <Dialog open={open} onOpenChange={setOpen}>
                <DialogContent>
                    ...
                    <GrupoAcademicoForm grupo={selectedGrupo} canSubmit={selectedGrupo ? canUpdate : canCreate} onSuccess={() => setOpen(false)}/>
                </DialogContent>
            </Dialog>

            <GrupoPostulantesDialog grupo={selectedPostulantesGrupo} open={postulantesOpen} onOpenChange={setPostulantesOpen}/>
        </>);
}
