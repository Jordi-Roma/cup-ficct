...
import type { Docente, DocenteFilters } from '../types/docente';
...
export default function DocentesPage({ docentes, filters }: Props) {
    ...
    const [selectedDocente, setSelectedDocente] = useState<Docente | null>(
        null,
    );
    const [localFilters, setLocalFilters] = useState<DocenteFilters>({
        ...
        diplomado_educacion_superior:
            filters.diplomado_educacion_superior ?? '',
    });
    ...
    const summary = useMemo(() => {
        ...
        const qualified = docentes.filter(
            (docente) =>
            ...
            <div className="space-y-6 p-4 md:p-6">
                ...
                <Card>
                    ...
                    <div className="grid gap-3 px-6 pb-6 md:grid-cols-3 xl:grid-cols-6">
                        ...
                        />
                        <BooleanFilter
                            value={localFilters.profesional_area}
                        ...
                        />
                        <BooleanFilter
                            value={localFilters.diplomado_educacion_superior}
            ...
            <Dialog open={open} onOpenChange={setOpen}>
                <DialogContent className="max-h-[90vh] overflow-y-auto sm:max-w-3xl">
                    ...
                    <DocenteForm
                        ...
                        canSubmit={selectedDocente ? canUpdate : canCreate}
...
function normalizeFilters(filters: DocenteFilters) {
