...
type Props = {
    asignacion?: AsignacionAcademica | null;
    options: AsignacionOptions;
    canSubmit: boolean;
    onSuccess: () => void;
};

export default function AsignacionAcademicaForm({
    asignacion,
    options,
    canSubmit,
    onSuccess,
    ...
    return (
        <form onSubmit={submit} className="space-y-5">
            <div className="grid gap-4 sm:grid-cols-2">
                ...
                <div className="sm:col-span-2">
                    <SelectField
                        ...
                        items={options.horarios.map((horario) => ({
            ...
            <InputError
                message={(errors as Record<string, string>).asignacion}
            />
