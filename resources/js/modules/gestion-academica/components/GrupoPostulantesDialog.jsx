...
export default function GrupoPostulantesDialog({ grupo, open, onOpenChange, }) {
                ...
                {postulantes.length === 0 ? (<div className="rounded-md border p-6 text-sm text-muted-foreground">
                    ...
                    : 'Pendiente'}
                        ...
                        <div className="grid gap-3 p-3 xl:hidden">
                            {postulantes.map((postulante) => (<div key={postulante.id_postulante} className="space-y-2 rounded-md border p-4">
