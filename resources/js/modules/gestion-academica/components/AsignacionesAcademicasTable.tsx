...
import type { AsignacionAcademica } from '../types/asignacion-academica';

type Props = {
    asignaciones: AsignacionAcademica[];
    canUpdate: boolean;
    canToggle: boolean;
    onEdit: (asignacion: AsignacionAcademica) => void;
};

export default function AsignacionesAcademicasTable({
    asignaciones,
    canUpdate,
    canToggle,
    onEdit,
}: Props) {
    const toggle = (asignacion: AsignacionAcademica) => {
        router.patch(
            `/academico/asignaciones/${asignacion.id_asignacion}/toggle`,
            undefined,
            { preserveScroll: true },
        );
    };
