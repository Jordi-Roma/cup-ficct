...
use App\Modules\GestionAcademica\Requests\UpsertCupoCarreraRequest;
use App\Modules\GestionAcademica\Services\AdmisionCupoService;
...
class AdmisionCupoController extends BaseController
{
    ...
    public function index(Request $request): Response
    {
        ...
        return Inertia::render('gestion-academica/admision-cupos', [
